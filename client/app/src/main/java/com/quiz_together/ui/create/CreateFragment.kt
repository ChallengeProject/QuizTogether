...
Log.i(TAG,        Broadcast(null, title, description, scheduledTime, null, giftType,
                prize, giftDescription, Repository.getUserId(), null, winnersMsg, null,
                questionList, questionCount, null).toString())
...
////
////
////        val aaa = mutableListOf<Question>()
////
////
////
////
////        aaa.add(Question(1, null,QuestionProp("aa", arrayListOf("AAAAAAAAAAAAAA","AA","AA")), CategoryType.NORMAL))
////        aaa.add(Question(2, null,QuestionProp("aa2", arrayListOf("AA","AAAAAAAAAAAAAA","AA")), CategoryType.NORMAL))
//////        aaa.add(Question(3, null, QuestionProp("aa3", arrayListOf("AA","AA","AAAAAAAAAAAAAA")), CategoryType.NORMAL))
////
////        val bbb =Broadcast(null, "aaa", "aaa", scheduledTime, null, GiftType.PRIZE,
////                1111111, "", Repository.getUserId(), null, "aaaa", null,
////                aaa, 2, null)
////
////
////        return bbb
